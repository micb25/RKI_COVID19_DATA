...
plot \
	...
	"<awk -F, '{ if ((NR>1)&&($3>0)) print 17-$3, 100*$5 }' ../RKI_COVID19_Impfquotenmonitoring.csv | tail -n 16" using ($2/population_cnt(18-$1)):($1):(sprintf("%.0f (%.1f%%)", $2/100, $2/population_cnt(18-$1))) with labels left offset graph 0.01, 0.0
